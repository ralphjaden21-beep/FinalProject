(function () {
    ...
    const customization = params.get("customization") || null;
    const form = document.getElementById("order-form");
    const productTitle = document.getElementById("order-product");
    const priceText = document.getElementById("order-price");
    const customizationDiv = document.getElementById("customization-details");
    ...
    if (customization) {
        customizationDiv.textContent = customization;
